...
public class SimHash {
    ...
    public SimHash(String tokens) {
        this.tokens = tokens;
        this.setIntSimHash(this.simHash());
    }
    ...
    public int hammingDistance(SimHash other) {
        ...
        BigInteger x = this.getIntSimHash().xor(other.getIntSimHash());
        int tot = 0;
    ...
    public List<BigInteger> subByDistance(SimHash simHash, int distance){
    	...
    	int k = 0;
    	for( int i = 0; i < this.getIntSimHash().bitLength(); i++){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hash1.getIntSimHash() + "  " + hash1.getIntSimHash().bitLength());
        ...
        System.out.println(hash2.getIntSimHash()+ "  " + hash2.getIntSimHash().bitCount());
